...
{
    private readonly string _star1DataPath = Path.Combine(TestSetup.RootPath, @"src\Day04\Data1.txt");
    private readonly string _star2DataPath = Path.Combine(TestSetup.RootPath, @"src\Day04\Data2.txt");

    public Day04Tests()
    {
        SetWorkingDirectory(@"src\Day04");
    }
